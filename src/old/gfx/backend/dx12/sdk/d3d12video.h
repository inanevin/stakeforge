...
#define __ID3D12VideoEncoderHeap1_INTERFACE_DEFINED__
	...
	typedef struct ID3D12VideoEncoderHeap1Vtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(ID3D12VideoEncoderHeap1* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(ID3D12VideoEncoderHeap1* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(ID3D12VideoEncoderHeap1* This);

		DECLSPEC_XFGVIRT(ID3D12Object, GetPrivateData)
		HRESULT(STDMETHODCALLTYPE* GetPrivateData)(ID3D12VideoEncoderHeap1* This, _In_ REFGUID guid, _Inout_ UINT* pDataSize, _Out_writes_bytes_opt_(*pDataSize) void* pData);

		DECLSPEC_XFGVIRT(ID3D12Object, SetPrivateData)
		HRESULT(STDMETHODCALLTYPE* SetPrivateData)(ID3D12VideoEncoderHeap1* This, _In_ REFGUID guid, _In_ UINT DataSize, _In_reads_bytes_opt_(DataSize) const void* pData);

		DECLSPEC_XFGVIRT(ID3D12Object, SetPrivateDataInterface)
		HRESULT(STDMETHODCALLTYPE* SetPrivateDataInterface)(ID3D12VideoEncoderHeap1* This, _In_ REFGUID guid, _In_opt_ const IUnknown* pData);

		DECLSPEC_XFGVIRT(ID3D12Object, SetName)
		HRESULT(STDMETHODCALLTYPE* SetName)(ID3D12VideoEncoderHeap1* This, _In_z_ LPCWSTR Name);

		DECLSPEC_XFGVIRT(ID3D12DeviceChild, GetDevice)
		HRESULT(STDMETHODCALLTYPE* GetDevice)(ID3D12VideoEncoderHeap1* This, REFIID riid, _COM_Outptr_opt_ void** ppvDevice);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetNodeMask)
		UINT(STDMETHODCALLTYPE* GetNodeMask)(ID3D12VideoEncoderHeap1* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetEncoderHeapFlags)
		D3D12_VIDEO_ENCODER_HEAP_FLAGS(STDMETHODCALLTYPE* GetEncoderHeapFlags)(ID3D12VideoEncoderHeap1* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetCodec)
		D3D12_VIDEO_ENCODER_CODEC(STDMETHODCALLTYPE* GetCodec)(ID3D12VideoEncoderHeap1* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetCodecProfile)
		HRESULT(STDMETHODCALLTYPE* GetCodecProfile)(ID3D12VideoEncoderHeap1* This, _Inout_ D3D12_VIDEO_ENCODER_PROFILE_DESC dstProfile);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetCodecLevel)
		HRESULT(STDMETHODCALLTYPE* GetCodecLevel)(ID3D12VideoEncoderHeap1* This, _Inout_ D3D12_VIDEO_ENCODER_LEVEL_SETTING dstLevel);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetResolutionListCount)
		UINT(STDMETHODCALLTYPE* GetResolutionListCount)(ID3D12VideoEncoderHeap1* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap, GetResolutionList)
		HRESULT(STDMETHODCALLTYPE* GetResolutionList)(ID3D12VideoEncoderHeap1* This, const UINT ResolutionsListCount, _Out_writes_(ResolutionsListCount) D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_DESC* pResolutionList);

		DECLSPEC_XFGVIRT(ID3D12VideoEncoderHeap1, GetPow2DownscaleFactor)
		UINT(STDMETHODCALLTYPE* GetPow2DownscaleFactor)(ID3D12VideoEncoderHeap1* This);
...
#define ID3D12VideoEncoderHeap1_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define ID3D12VideoEncoderHeap1_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D12VideoEncoderHeap1_Release(This) ((This)->lpVtbl->Release(This))

#define ID3D12VideoEncoderHeap1_GetPrivateData(This, guid, pDataSize, pData) ((This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData))

#define ID3D12VideoEncoderHeap1_SetPrivateData(This, guid, DataSize, pData) ((This)->lpVtbl->SetPrivateData(This, guid, DataSize, pData))

#define ID3D12VideoEncoderHeap1_SetPrivateDataInterface(This, guid, pData) ((This)->lpVtbl->SetPrivateDataInterface(This, guid, pData))

#define ID3D12VideoEncoderHeap1_SetName(This, Name) ((This)->lpVtbl->SetName(This, Name))

#define ID3D12VideoEncoderHeap1_GetDevice(This, riid, ppvDevice) ((This)->lpVtbl->GetDevice(This, riid, ppvDevice))

#define ID3D12VideoEncoderHeap1_GetNodeMask(This) ((This)->lpVtbl->GetNodeMask(This))

#define ID3D12VideoEncoderHeap1_GetEncoderHeapFlags(This) ((This)->lpVtbl->GetEncoderHeapFlags(This))

#define ID3D12VideoEncoderHeap1_GetCodec(This) ((This)->lpVtbl->GetCodec(This))

#define ID3D12VideoEncoderHeap1_GetCodecProfile(This, dstProfile) ((This)->lpVtbl->GetCodecProfile(This, dstProfile))

#define ID3D12VideoEncoderHeap1_GetCodecLevel(This, dstLevel) ((This)->lpVtbl->GetCodecLevel(This, dstLevel))

#define ID3D12VideoEncoderHeap1_GetResolutionListCount(This) ((This)->lpVtbl->GetResolutionListCount(This))

#define ID3D12VideoEncoderHeap1_GetResolutionList(This, ResolutionsListCount, pResolutionList) ((This)->lpVtbl->GetResolutionList(This, ResolutionsListCount, pResolutionList))

#define ID3D12VideoEncoderHeap1_GetPow2DownscaleFactor(This) ((This)->lpVtbl->GetPow2DownscaleFactor(This))
...
#define __ID3D12VideoDevice4_INTERFACE_DEFINED__
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE CreateVideoEncoderHeap1(_In_ const D3D12_VIDEO_ENCODER_HEAP_DESC1* pDesc, _In_ REFIID riid, _COM_Outptr_ void** ppVideoEncoderHeap) = 0;
	};
	...
	typedef struct ID3D12VideoDevice4Vtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(ID3D12VideoDevice4* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(ID3D12VideoDevice4* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(ID3D12VideoDevice4* This);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice, CheckFeatureSupport)
		HRESULT(STDMETHODCALLTYPE* CheckFeatureSupport)(ID3D12VideoDevice4* This, D3D12_FEATURE_VIDEO FeatureVideo, _Inout_updates_bytes_(FeatureSupportDataSize) void* pFeatureSupportData, UINT FeatureSupportDataSize);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice, CreateVideoDecoder)
		HRESULT(STDMETHODCALLTYPE* CreateVideoDecoder)(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_DECODER_DESC* pDesc, _In_ REFIID riid, _COM_Outptr_ void** ppVideoDecoder);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice, CreateVideoDecoderHeap)
		HRESULT(STDMETHODCALLTYPE* CreateVideoDecoderHeap)(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_DECODER_HEAP_DESC* pVideoDecoderHeapDesc, _In_ REFIID riid, _COM_Outptr_ void** ppVideoDecoderHeap);
		...
		DECLSPEC_XFGVIRT(ID3D12VideoDevice1, CreateVideoMotionEstimator)
		HRESULT(STDMETHODCALLTYPE* CreateVideoMotionEstimator)
		(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_MOTION_ESTIMATOR_DESC* pDesc, _In_opt_ ID3D12ProtectedResourceSession* pProtectedResourceSession, _In_ REFIID riid, _COM_Outptr_ void** ppVideoMotionEstimator);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice1, CreateVideoMotionVectorHeap)
		HRESULT(STDMETHODCALLTYPE* CreateVideoMotionVectorHeap)
		(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC* pDesc, _In_opt_ ID3D12ProtectedResourceSession* pProtectedResourceSession, _In_ REFIID riid, _COM_Outptr_ void** ppVideoMotionVectorHeap);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice2, CreateVideoDecoder1)
		HRESULT(STDMETHODCALLTYPE* CreateVideoDecoder1)(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_DECODER_DESC* pDesc, _In_opt_ ID3D12ProtectedResourceSession* pProtectedResourceSession, _In_ REFIID riid, _COM_Outptr_ void** ppVideoDecoder);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice2, CreateVideoDecoderHeap1)
		HRESULT(STDMETHODCALLTYPE* CreateVideoDecoderHeap1)
		(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_DECODER_HEAP_DESC* pVideoDecoderHeapDesc, _In_opt_ ID3D12ProtectedResourceSession* pProtectedResourceSession, _In_ REFIID riid, _COM_Outptr_ void** ppVideoDecoderHeap);
		...
		DECLSPEC_XFGVIRT(ID3D12VideoDevice3, CreateVideoEncoder)
		HRESULT(STDMETHODCALLTYPE* CreateVideoEncoder)(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_ENCODER_DESC* pDesc, _In_ REFIID riid, _COM_Outptr_ void** ppVideoEncoder);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice3, CreateVideoEncoderHeap)
		HRESULT(STDMETHODCALLTYPE* CreateVideoEncoderHeap)(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_ENCODER_HEAP_DESC* pDesc, _In_ REFIID riid, _COM_Outptr_ void** ppVideoEncoderHeap);

		DECLSPEC_XFGVIRT(ID3D12VideoDevice4, CreateVideoEncoderHeap1)
		HRESULT(STDMETHODCALLTYPE* CreateVideoEncoderHeap1)(ID3D12VideoDevice4* This, _In_ const D3D12_VIDEO_ENCODER_HEAP_DESC1* pDesc, _In_ REFIID riid, _COM_Outptr_ void** ppVideoEncoderHeap);
...
#define ID3D12VideoDevice4_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define ID3D12VideoDevice4_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D12VideoDevice4_Release(This) ((This)->lpVtbl->Release(This))

#define ID3D12VideoDevice4_CheckFeatureSupport(This, FeatureVideo, pFeatureSupportData, FeatureSupportDataSize) ((This)->lpVtbl->CheckFeatureSupport(This, FeatureVideo, pFeatureSupportData, FeatureSupportDataSize))

#define ID3D12VideoDevice4_CreateVideoDecoder(This, pDesc, riid, ppVideoDecoder) ((This)->lpVtbl->CreateVideoDecoder(This, pDesc, riid, ppVideoDecoder))

#define ID3D12VideoDevice4_CreateVideoDecoderHeap(This, pVideoDecoderHeapDesc, riid, ppVideoDecoderHeap) ((This)->lpVtbl->CreateVideoDecoderHeap(This, pVideoDecoderHeapDesc, riid, ppVideoDecoderHeap))
...
#define ID3D12VideoDevice4_CreateVideoMotionEstimator(This, pDesc, pProtectedResourceSession, riid, ppVideoMotionEstimator) ((This)->lpVtbl->CreateVideoMotionEstimator(This, pDesc, pProtectedResourceSession, riid, ppVideoMotionEstimator))

#define ID3D12VideoDevice4_CreateVideoMotionVectorHeap(This, pDesc, pProtectedResourceSession, riid, ppVideoMotionVectorHeap) ((This)->lpVtbl->CreateVideoMotionVectorHeap(This, pDesc, pProtectedResourceSession, riid, ppVideoMotionVectorHeap))

#define ID3D12VideoDevice4_CreateVideoDecoder1(This, pDesc, pProtectedResourceSession, riid, ppVideoDecoder) ((This)->lpVtbl->CreateVideoDecoder1(This, pDesc, pProtectedResourceSession, riid, ppVideoDecoder))

#define ID3D12VideoDevice4_CreateVideoDecoderHeap1(This, pVideoDecoderHeapDesc, pProtectedResourceSession, riid, ppVideoDecoderHeap) ((This)->lpVtbl->CreateVideoDecoderHeap1(This, pVideoDecoderHeapDesc, pProtectedResourceSession, riid, ppVideoDecoderHeap))
...
#define ID3D12VideoDevice4_CreateVideoEncoder(This, pDesc, riid, ppVideoEncoder) ((This)->lpVtbl->CreateVideoEncoder(This, pDesc, riid, ppVideoEncoder))

#define ID3D12VideoDevice4_CreateVideoEncoderHeap(This, pDesc, riid, ppVideoEncoderHeap) ((This)->lpVtbl->CreateVideoEncoderHeap(This, pDesc, riid, ppVideoEncoderHeap))

#define ID3D12VideoDevice4_CreateVideoEncoderHeap1(This, pDesc, riid, ppVideoEncoderHeap) ((This)->lpVtbl->CreateVideoEncoderHeap1(This, pDesc, riid, ppVideoEncoderHeap))
...
#define __ID3D12VideoEncodeCommandList4_INTERFACE_DEFINED__
	...
	public:
		virtual void STDMETHODCALLTYPE EncodeFrame1(
			_In_ ID3D12VideoEncoder * pEncoder, _In_ ID3D12VideoEncoderHeap1 * pHeap, _In_ const D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS1* pInputArguments, _In_ const D3D12_VIDEO_ENCODER_ENCODEFRAME_OUTPUT_ARGUMENTS1* pOutputArguments) = 0;

		virtual void STDMETHODCALLTYPE ResolveEncoderOutputMetadata1(_In_ const D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS1* pInputArguments, _In_ const D3D12_VIDEO_ENCODER_RESOLVE_METADATA_OUTPUT_ARGUMENTS1* pOutputArguments) = 0;

		virtual void STDMETHODCALLTYPE ResolveInputParamLayout(_In_ const D3D12_VIDEO_ENCODER_RESOLVE_INPUT_PARAM_LAYOUT_INPUT_ARGUMENTS* pInputArguments, _In_ const D3D12_VIDEO_ENCODER_RESOLVE_INPUT_PARAM_LAYOUT_OUTPUT_ARGUMENTS* pOutputArguments) = 0;
	};
	...
	typedef struct ID3D12VideoEncodeCommandList4Vtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(ID3D12VideoEncodeCommandList4* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(ID3D12VideoEncodeCommandList4* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(ID3D12VideoEncodeCommandList4* This);

		DECLSPEC_XFGVIRT(ID3D12Object, GetPrivateData)
		HRESULT(STDMETHODCALLTYPE* GetPrivateData)(ID3D12VideoEncodeCommandList4* This, _In_ REFGUID guid, _Inout_ UINT* pDataSize, _Out_writes_bytes_opt_(*pDataSize) void* pData);

		DECLSPEC_XFGVIRT(ID3D12Object, SetPrivateData)
		HRESULT(STDMETHODCALLTYPE* SetPrivateData)(ID3D12VideoEncodeCommandList4* This, _In_ REFGUID guid, _In_ UINT DataSize, _In_reads_bytes_opt_(DataSize) const void* pData);

		DECLSPEC_XFGVIRT(ID3D12Object, SetPrivateDataInterface)
		HRESULT(STDMETHODCALLTYPE* SetPrivateDataInterface)(ID3D12VideoEncodeCommandList4* This, _In_ REFGUID guid, _In_opt_ const IUnknown* pData);

		DECLSPEC_XFGVIRT(ID3D12Object, SetName)
		HRESULT(STDMETHODCALLTYPE* SetName)(ID3D12VideoEncodeCommandList4* This, _In_z_ LPCWSTR Name);

		DECLSPEC_XFGVIRT(ID3D12DeviceChild, GetDevice)
		HRESULT(STDMETHODCALLTYPE* GetDevice)(ID3D12VideoEncodeCommandList4* This, REFIID riid, _COM_Outptr_opt_ void** ppvDevice);

		DECLSPEC_XFGVIRT(ID3D12CommandList, GetType)
		D3D12_COMMAND_LIST_TYPE(STDMETHODCALLTYPE* GetType)(ID3D12VideoEncodeCommandList4* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, Close)
		HRESULT(STDMETHODCALLTYPE* Close)(ID3D12VideoEncodeCommandList4* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, Reset)
		HRESULT(STDMETHODCALLTYPE* Reset)(ID3D12VideoEncodeCommandList4* This, _In_ ID3D12CommandAllocator* pAllocator);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, ClearState)
		void(STDMETHODCALLTYPE* ClearState)(ID3D12VideoEncodeCommandList4* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, ResourceBarrier)
		void(STDMETHODCALLTYPE* ResourceBarrier)(ID3D12VideoEncodeCommandList4* This, _In_ UINT NumBarriers, _In_reads_(NumBarriers) const D3D12_RESOURCE_BARRIER* pBarriers);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, DiscardResource)
		void(STDMETHODCALLTYPE* DiscardResource)(ID3D12VideoEncodeCommandList4* This, _In_ ID3D12Resource* pResource, _In_opt_ const D3D12_DISCARD_REGION* pRegion);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, BeginQuery)
		void(STDMETHODCALLTYPE* BeginQuery)(ID3D12VideoEncodeCommandList4* This, _In_ ID3D12QueryHeap* pQueryHeap, _In_ D3D12_QUERY_TYPE Type, _In_ UINT Index);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, EndQuery)
		void(STDMETHODCALLTYPE* EndQuery)(ID3D12VideoEncodeCommandList4* This, _In_ ID3D12QueryHeap* pQueryHeap, _In_ D3D12_QUERY_TYPE Type, _In_ UINT Index);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, ResolveQueryData)
		void(STDMETHODCALLTYPE* ResolveQueryData)(
			ID3D12VideoEncodeCommandList4* This, _In_ ID3D12QueryHeap* pQueryHeap, _In_ D3D12_QUERY_TYPE Type, _In_ UINT StartIndex, _In_ UINT NumQueries, _In_ ID3D12Resource* pDestinationBuffer, _In_ UINT64 AlignedDestinationBufferOffset);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, SetPredication)
		void(STDMETHODCALLTYPE* SetPredication)(ID3D12VideoEncodeCommandList4* This, _In_opt_ ID3D12Resource* pBuffer, _In_ UINT64 AlignedBufferOffset, _In_ D3D12_PREDICATION_OP Operation);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, SetMarker)
		void(STDMETHODCALLTYPE* SetMarker)(ID3D12VideoEncodeCommandList4* This, UINT Metadata, _In_reads_bytes_opt_(Size) const void* pData, UINT Size);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, BeginEvent)
		void(STDMETHODCALLTYPE* BeginEvent)(ID3D12VideoEncodeCommandList4* This, UINT Metadata, _In_reads_bytes_opt_(Size) const void* pData, UINT Size);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, EndEvent)
		void(STDMETHODCALLTYPE* EndEvent)(ID3D12VideoEncodeCommandList4* This);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, EstimateMotion)
		void(STDMETHODCALLTYPE* EstimateMotion)(ID3D12VideoEncodeCommandList4*					This,
												_In_ ID3D12VideoMotionEstimator*				pMotionEstimator,
												_In_ const D3D12_VIDEO_MOTION_ESTIMATOR_OUTPUT* pOutputArguments,
												_In_ const D3D12_VIDEO_MOTION_ESTIMATOR_INPUT*	pInputArguments);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, ResolveMotionVectorHeap)
		void(STDMETHODCALLTYPE* ResolveMotionVectorHeap)(ID3D12VideoEncodeCommandList4* This, const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT* pOutputArguments, const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT* pInputArguments);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, WriteBufferImmediate)
		void(STDMETHODCALLTYPE* WriteBufferImmediate)(ID3D12VideoEncodeCommandList4* This, UINT Count, _In_reads_(Count) const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER* pParams, _In_reads_opt_(Count) const D3D12_WRITEBUFFERIMMEDIATE_MODE* pModes);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList, SetProtectedResourceSession)
		void(STDMETHODCALLTYPE* SetProtectedResourceSession)(ID3D12VideoEncodeCommandList4* This, _In_opt_ ID3D12ProtectedResourceSession* pProtectedResourceSession);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList1, InitializeExtensionCommand)
		void(STDMETHODCALLTYPE* InitializeExtensionCommand)(ID3D12VideoEncodeCommandList4*									  This,
															_In_ ID3D12VideoExtensionCommand*								  pExtensionCommand,
															_In_reads_bytes_(InitializationParametersSizeInBytes) const void* pInitializationParameters,
															SIZE_T															  InitializationParametersSizeInBytes);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList1, ExecuteExtensionCommand)
		void(STDMETHODCALLTYPE* ExecuteExtensionCommand)(ID3D12VideoEncodeCommandList4*								  This,
														 _In_ ID3D12VideoExtensionCommand*							  pExtensionCommand,
														 _In_reads_bytes_(ExecutionParametersSizeInBytes) const void* pExecutionParameters,
														 SIZE_T														  ExecutionParametersSizeInBytes);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList2, EncodeFrame)
		void(STDMETHODCALLTYPE* EncodeFrame)(ID3D12VideoEncodeCommandList4*								  This,
											 _In_ ID3D12VideoEncoder*									  pEncoder,
											 _In_ ID3D12VideoEncoderHeap*								  pHeap,
											 _In_ const D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS*  pInputArguments,
											 _In_ const D3D12_VIDEO_ENCODER_ENCODEFRAME_OUTPUT_ARGUMENTS* pOutputArguments);
		...
		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList2, ResolveEncoderOutputMetadata)
		void(STDMETHODCALLTYPE* ResolveEncoderOutputMetadata)(ID3D12VideoEncodeCommandList4*									This,
															  _In_ const D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS*	pInputArguments,
															  _In_ const D3D12_VIDEO_ENCODER_RESOLVE_METADATA_OUTPUT_ARGUMENTS* pOutputArguments);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList3, Barrier)
		void(STDMETHODCALLTYPE* Barrier)(ID3D12VideoEncodeCommandList4* This, UINT32 NumBarrierGroups, _In_reads_(NumBarrierGroups) const D3D12_BARRIER_GROUP* pBarrierGroups);

		DECLSPEC_XFGVIRT(ID3D12VideoEncodeCommandList4, EncodeFrame1)
		void(STDMETHODCALLTYPE* EncodeFrame1)(ID3D12VideoEncodeCommandList4*								This,
											  _In_ ID3D12VideoEncoder*										pEncoder,
		...
		void(STDMETHODCALLTYPE* ResolveEncoderOutputMetadata1)(ID3D12VideoEncodeCommandList4*									  This,
		...
		void(STDMETHODCALLTYPE* ResolveInputParamLayout)(ID3D12VideoEncodeCommandList4*												 This,
...
#define ID3D12VideoEncodeCommandList4_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define ID3D12VideoEncodeCommandList4_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D12VideoEncodeCommandList4_Release(This) ((This)->lpVtbl->Release(This))

#define ID3D12VideoEncodeCommandList4_GetPrivateData(This, guid, pDataSize, pData) ((This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData))

#define ID3D12VideoEncodeCommandList4_SetPrivateData(This, guid, DataSize, pData) ((This)->lpVtbl->SetPrivateData(This, guid, DataSize, pData))

#define ID3D12VideoEncodeCommandList4_SetPrivateDataInterface(This, guid, pData) ((This)->lpVtbl->SetPrivateDataInterface(This, guid, pData))

#define ID3D12VideoEncodeCommandList4_SetName(This, Name) ((This)->lpVtbl->SetName(This, Name))

#define ID3D12VideoEncodeCommandList4_GetDevice(This, riid, ppvDevice) ((This)->lpVtbl->GetDevice(This, riid, ppvDevice))

#define ID3D12VideoEncodeCommandList4_GetType(This) ((This)->lpVtbl->GetType(This))

#define ID3D12VideoEncodeCommandList4_Close(This) ((This)->lpVtbl->Close(This))

#define ID3D12VideoEncodeCommandList4_Reset(This, pAllocator) ((This)->lpVtbl->Reset(This, pAllocator))

#define ID3D12VideoEncodeCommandList4_ClearState(This) ((This)->lpVtbl->ClearState(This))

#define ID3D12VideoEncodeCommandList4_ResourceBarrier(This, NumBarriers, pBarriers) ((This)->lpVtbl->ResourceBarrier(This, NumBarriers, pBarriers))

#define ID3D12VideoEncodeCommandList4_DiscardResource(This, pResource, pRegion) ((This)->lpVtbl->DiscardResource(This, pResource, pRegion))

#define ID3D12VideoEncodeCommandList4_BeginQuery(This, pQueryHeap, Type, Index) ((This)->lpVtbl->BeginQuery(This, pQueryHeap, Type, Index))

#define ID3D12VideoEncodeCommandList4_EndQuery(This, pQueryHeap, Type, Index) ((This)->lpVtbl->EndQuery(This, pQueryHeap, Type, Index))
...
#define ID3D12VideoEncodeCommandList4_SetPredication(This, pBuffer, AlignedBufferOffset, Operation) ((This)->lpVtbl->SetPredication(This, pBuffer, AlignedBufferOffset, Operation))

#define ID3D12VideoEncodeCommandList4_SetMarker(This, Metadata, pData, Size) ((This)->lpVtbl->SetMarker(This, Metadata, pData, Size))

#define ID3D12VideoEncodeCommandList4_BeginEvent(This, Metadata, pData, Size) ((This)->lpVtbl->BeginEvent(This, Metadata, pData, Size))

#define ID3D12VideoEncodeCommandList4_EndEvent(This) ((This)->lpVtbl->EndEvent(This))

#define ID3D12VideoEncodeCommandList4_EstimateMotion(This, pMotionEstimator, pOutputArguments, pInputArguments) ((This)->lpVtbl->EstimateMotion(This, pMotionEstimator, pOutputArguments, pInputArguments))

#define ID3D12VideoEncodeCommandList4_ResolveMotionVectorHeap(This, pOutputArguments, pInputArguments) ((This)->lpVtbl->ResolveMotionVectorHeap(This, pOutputArguments, pInputArguments))

#define ID3D12VideoEncodeCommandList4_WriteBufferImmediate(This, Count, pParams, pModes) ((This)->lpVtbl->WriteBufferImmediate(This, Count, pParams, pModes))

#define ID3D12VideoEncodeCommandList4_SetProtectedResourceSession(This, pProtectedResourceSession) ((This)->lpVtbl->SetProtectedResourceSession(This, pProtectedResourceSession))
...
#define ID3D12VideoEncodeCommandList4_EncodeFrame(This, pEncoder, pHeap, pInputArguments, pOutputArguments) ((This)->lpVtbl->EncodeFrame(This, pEncoder, pHeap, pInputArguments, pOutputArguments))

#define ID3D12VideoEncodeCommandList4_ResolveEncoderOutputMetadata(This, pInputArguments, pOutputArguments) ((This)->lpVtbl->ResolveEncoderOutputMetadata(This, pInputArguments, pOutputArguments))

#define ID3D12VideoEncodeCommandList4_Barrier(This, NumBarrierGroups, pBarrierGroups) ((This)->lpVtbl->Barrier(This, NumBarrierGroups, pBarrierGroups))

#define ID3D12VideoEncodeCommandList4_EncodeFrame1(This, pEncoder, pHeap, pInputArguments, pOutputArguments) ((This)->lpVtbl->EncodeFrame1(This, pEncoder, pHeap, pInputArguments, pOutputArguments))

#define ID3D12VideoEncodeCommandList4_ResolveEncoderOutputMetadata1(This, pInputArguments, pOutputArguments) ((This)->lpVtbl->ResolveEncoderOutputMetadata1(This, pInputArguments, pOutputArguments))

#define ID3D12VideoEncodeCommandList4_ResolveInputParamLayout(This, pInputArguments, pOutputArguments) ((This)->lpVtbl->ResolveInputParamLayout(This, pInputArguments, pOutputArguments))
