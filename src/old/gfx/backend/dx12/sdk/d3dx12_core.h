...
template <typename _T> class CArrayComPtr
{
...
public:
	...
	CArrayComPtr(size_t size) : m_array(size)
	{
	}
...
struct CD3DX12_RASTERIZER_DESC2 : public D3D12_RASTERIZER_DESC2
{
	...
	explicit CD3DX12_RASTERIZER_DESC2(const D3D12_RASTERIZER_DESC& o) noexcept : CD3DX12_RASTERIZER_DESC2(CD3DX12_RASTERIZER_DESC1(o))
	{
	}
	...
	explicit CD3DX12_RASTERIZER_DESC2(D3D12_FILL_MODE						fillMode,
									  D3D12_CULL_MODE						cullMode,
									  BOOL									frontCounterClockwise,
									  FLOAT									depthBias,
									  FLOAT									depthBiasClamp,
...
inline const CD3DX12_RESOURCE_DESC1* D3DX12ConditionallyExpandAPIDesc(CD3DX12_RESOURCE_DESC1& LclDesc, const CD3DX12_RESOURCE_DESC1* pDesc, const bool tightAlignmentSupported = false, const bool alignAsCommitted = false)
{
	// Expand mip levels:
	if (pDesc->MipLevels == 0 || pDesc->Alignment == 0)
	{
		...
		if (pDesc->Alignment == 0)
		{
			...
			else if (!(tightAlignmentSupported && (pDesc->Flags & D3D12_RESOURCE_FLAG_USE_TIGHT_ALIGNMENT)) || (pDesc->Flags & D3D12_RESOURCE_FLAG_ALLOW_CROSS_ADAPTER))
			{
...
struct CD3DX12_SHADER_RESOURCE_VIEW_DESC : public D3D12_SHADER_RESOURCE_VIEW_DESC
{
	...
	explicit CD3DX12_SHADER_RESOURCE_VIEW_DESC(const D3D12_SHADER_RESOURCE_VIEW_DESC& o) noexcept : D3D12_SHADER_RESOURCE_VIEW_DESC(o)
	{
	}

	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC StructuredBuffer(UINT NumElements, UINT StructureByteStride, UINT64 FirstElement = 0) noexcept
	{
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC RawBuffer(UINT NumElements, UINT64 FirstElement = 0) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC TypedBuffer(DXGI_FORMAT Format, UINT NumElements, UINT64 FirstElement = 0, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format						= Format;
		desc.ViewDimension				= D3D12_SRV_DIMENSION_BUFFER;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex1D(DXGI_FORMAT Format, UINT MipLevels = -1, UINT MostDetailedMip = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format						   = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex1DArray(
		DXGI_FORMAT Format, UINT ArraySize = -1, UINT MipLevels = -1, UINT FirstArraySlice = 0, UINT MostDetailedMip = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format								= Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex2D(
		DXGI_FORMAT Format, UINT MipLevels = -1, UINT MostDetailedMip = 0, UINT PlaneSlice = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format						   = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex2DArray(
		DXGI_FORMAT Format, UINT ArraySize = -1, UINT MipLevels = -1, UINT FirstArraySlice = 0, UINT MostDetailedMip = 0, UINT PlaneSlice = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format								= Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex2DMS(DXGI_FORMAT Format, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format					 = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex2DMSArray(DXGI_FORMAT Format, UINT ArraySize, UINT FirstArraySlice = 0, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format							  = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC Tex3D(DXGI_FORMAT Format, UINT MipLevels = -1, UINT MostDetailedMip = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format						   = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC TexCube(DXGI_FORMAT Format, UINT MipLevels = -1, UINT MostDetailedMip = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format							 = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC TexCubeArray(
		DXGI_FORMAT Format, UINT NumCubes, UINT MipLevels = -1, UINT First2DArrayFace = 0, UINT MostDetailedMip = 0, FLOAT ResourceMinLODClamp = 0.0f, UINT Shader4ComponentMapping = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format								  = Format;
	...
	static inline CD3DX12_SHADER_RESOURCE_VIEW_DESC RaytracingAccelStruct(D3D12_GPU_VIRTUAL_ADDRESS Location) noexcept
	{
		CD3DX12_SHADER_RESOURCE_VIEW_DESC desc;
		desc.Format									  = DXGI_FORMAT_UNKNOWN;
...
struct CD3DX12_UNORDERED_ACCESS_VIEW_DESC : public D3D12_UNORDERED_ACCESS_VIEW_DESC
{
	...
	explicit CD3DX12_UNORDERED_ACCESS_VIEW_DESC(const D3D12_UNORDERED_ACCESS_VIEW_DESC& o) noexcept : D3D12_UNORDERED_ACCESS_VIEW_DESC(o)
	{
	}

	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC StructuredBuffer(UINT NumElements, UINT StructureByteStride, UINT64 FirstElement = 0, UINT64 CounterOffsetInBytes = 0) noexcept
	{
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC RawBuffer(UINT NumElements, UINT64 FirstElement = 0, UINT64 CounterOffsetInBytes = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format						 = DXGI_FORMAT_R32_UINT;
		desc.ViewDimension				 = D3D12_UAV_DIMENSION_BUFFER;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC TypedBuffer(DXGI_FORMAT Format, UINT NumElements, UINT64 FirstElement = 0, UINT64 CounterOffsetInBytes = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format						 = Format;
		desc.ViewDimension				 = D3D12_UAV_DIMENSION_BUFFER;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex1D(DXGI_FORMAT Format, UINT MipSlice = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format				= Format;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex1DArray(DXGI_FORMAT Format, UINT ArraySize = -1, UINT FirstArraySlice = 0, UINT MipSlice = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format							= Format;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex2D(DXGI_FORMAT Format, UINT MipSlice = 0, UINT PlaneSlice = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format				  = Format;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex2DArray(DXGI_FORMAT Format, UINT ArraySize = -1, UINT FirstArraySlice = 0, UINT MipSlice = 0, UINT PlaneSlice = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format							= Format;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex2DMS(DXGI_FORMAT Format) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format		   = Format;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex2DMSArray(DXGI_FORMAT Format, UINT ArraySize = -1, UINT FirstArraySlice = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format							  = Format;
	...
	static inline CD3DX12_UNORDERED_ACCESS_VIEW_DESC Tex3D(DXGI_FORMAT Format, UINT WSize = -1, UINT FirstWSlice = 0, UINT MipSlice = 0) noexcept
	{
		CD3DX12_UNORDERED_ACCESS_VIEW_DESC desc;
		desc.Format				   = Format;
...
struct CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC : public D3D12_SERIALIZED_ROOT_SIGNATURE_DESC
{
	...
	explicit CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC(const D3D12_SERIALIZED_ROOT_SIGNATURE_DESC& o) noexcept : D3D12_SERIALIZED_ROOT_SIGNATURE_DESC(o)
	{
	}
