			...
			.fields =
				{
					...
					{.name = "initial_blend_value", .display_name = "Blend Value 1D", .offset = offsetof(animation_graph_clip_def_t, blend_value), .size = sizeof(f32), .type = reflected_value_type_e::f32},
			...
			.fields =
				{
					...
					{.name = "priority", .display_name = "Priority", .offset = offsetof(animation_graph_asm_transition_def_t, priority), .size = sizeof(u32), .type = reflected_value_type_e::u32},
					...
					{.name = "is_interruptible", .display_name = "Interruptible", .offset = offsetof(animation_graph_asm_transition_def_t, is_interruptible), .size = sizeof(bool), .type = reflected_value_type_e::boolean},
					{.name = "restart_target", .display_name = "Restart Target", .offset = offsetof(animation_graph_asm_transition_def_t, restart_target), .size = sizeof(bool), .type = reflected_value_type_e::boolean},
				},
