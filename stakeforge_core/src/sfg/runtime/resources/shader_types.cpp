			...
			.fields =
				{
					...
					{.name = "opaque_shader", .display_name = "Opaque Shader"},
					{.name = "transparent_shader", .display_name = "Transparent Shader"},
					...
					{.name = "editor_debug_line", .display_name = "Editor Debug Line"},
					{.name = "editor_debug_text", .display_name = "Editor Debug Text"},
				},
