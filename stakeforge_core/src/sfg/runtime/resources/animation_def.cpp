			...
			.fields =
				{
					...
					{
						.container_ops =
							reflection_container_ops_t::sized_array_ops<animation_def_t, animation_event_def_t, MAX_CLIP_EVENTS, &animation_def_t::events, &animation_def_t::event_count>(reflected_value_type_e::object, type_id_t<animation_event_def_t>::value),
						.name		  = "events",
						.display_name = "Events",
						.offset		  = 0,
