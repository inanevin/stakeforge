...
namespace sfg
{
	...
	extern bool material_load_cpu(resource_entry_t& entry, span_t<const u8> data, resource_context_t& ctx);
	...
	extern void register_material_resource(resource_manager_t& resource_manager);
}
