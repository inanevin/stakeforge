...
namespace sfg
{
	...
	bool shader_cook_variants_t::cook_editor_ui(const string_t& source, const vector_t<string_t>& include_paths, vector_t<cook_compile_variant_t>& out_compiles, vector_t<cook_pso_variant_t>& out_psos)
	{
