			...
			.fields =
				{
					...
					{
						.name		  = "blend_position",
						.display_name = "Blend position",
						.sub_type_id  = type_id_t<vec2f_t>::value,
						.offset		  = offsetof(animation_library_clip_def_t, blend_position),
						.size		  = sizeof(animation_library_clip_def_t::blend_position),
						.type		  = reflected_value_type_e::object,
					},
					{
						.name		  = "start_time",
						.display_name = "Start time",
						.offset		  = offsetof(animation_library_clip_def_t, start_time),
						.size		  = sizeof(animation_library_clip_def_t::start_time),
						.type		  = reflected_value_type_e::f32,
					},
					{
						.name		  = "duration",
						.display_name = "Duration",
						.offset		  = offsetof(animation_library_clip_def_t, duration),
						.size		  = sizeof(animation_library_clip_def_t::duration),
						.type		  = reflected_value_type_e::f32,
					},
					{
						.name		  = "playback_speed",
						.display_name = "Playback speed",
						.offset		  = offsetof(animation_library_clip_def_t, playback_speed),
						.size		  = sizeof(animation_library_clip_def_t::playback_speed),
						.type		  = reflected_value_type_e::f32,
					},
				},
			...
			.fields =
				{
					...
					},
					{
						.name		  = "speed",
						.display_name = "Speed",
						.offset		  = offsetof(animation_library_state_def_t, speed),
						.size		  = sizeof(animation_library_state_def_t::speed),
						.type		  = reflected_value_type_e::f32,
					},
					{
						.name		  = "blend_type",
					...
					},
					{
						.name		  = "loop",
						.display_name = "Loop",
						.offset		  = offsetof(animation_library_state_def_t, loop),
						.size		  = sizeof(animation_library_state_def_t::loop),
			...
			.fields =
				{
					...
					},
					{
						.name		  = "mask",
						.display_name = "Mask",
						.offset		  = offsetof(animation_library_layer_def_t, mask),
						.size		  = sizeof(animation_library_layer_def_t::mask),
						.type		  = reflected_value_type_e::u64,
					},
					{
			...
			.fields =
				{
					...
					{
						.container_ops = reflection_container_ops_t::sized_array_ops<animation_library_def_t, animation_library_layer_def_t, MAX_ANIMATION_LIBRARY_LAYERS, &animation_library_def_t::layers, &animation_library_def_t::layer_count>(
							reflected_value_type_e::object, type_id_t<animation_library_layer_def_t>::value),
						.name		  = "layers",
						.display_name = "Layers",
						.offset		  = 0,
