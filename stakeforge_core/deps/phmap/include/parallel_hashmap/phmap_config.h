...
#elif (defined(__clang__) && defined(_LIBCPP_VERSION)) || (!defined(__clang__) && defined(__GNUC__) && (__GNUC__ > 5 || (__GNUC__ == 5 && __GNUC_MINOR__ >= 1)) && (defined(_LIBCPP_VERSION) || defined(__GLIBCXX__))) || (defined(_MSC_VER) && !defined(__NVCC__))
