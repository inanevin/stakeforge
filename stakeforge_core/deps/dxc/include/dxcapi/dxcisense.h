...
struct IDxcCursor : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE FindReferencesInFile(_In_ IDxcFile* file, unsigned skip, unsigned top, _Out_ unsigned* pResultLength, _Outptr_result_buffer_maybenull_(*pResultLength) IDxcCursor*** pResult) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE GetChildren(unsigned skip, unsigned top, _Out_ unsigned* pResultLength, _Outptr_result_buffer_maybenull_(*pResultLength) IDxcCursor*** pResult) = 0;
...
{
	virtual HRESULT STDMETHODCALLTYPE FormatDiagnostic(DxcDiagnosticDisplayOptions options, _Outptr_result_maybenull_ LPSTR* pResult)										= 0;
	...
	virtual HRESULT STDMETHODCALLTYPE GetFixItAt(unsigned index, _Outptr_result_nullonfailure_ IDxcSourceRange** pReplacementRange, _Outptr_result_maybenull_ LPSTR* pText) = 0;
};
...
struct IDxcIntelliSense : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE GetRange(_In_ IDxcSourceLocation* start, _In_ IDxcSourceLocation* end, _Outptr_result_nullonfailure_ IDxcSourceRange** location)				 = 0;
	virtual HRESULT STDMETHODCALLTYPE GetDefaultDiagnosticDisplayOptions(_Out_ DxcDiagnosticDisplayOptions* pValue)																	 = 0;
...
struct IDxcIndex : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE ParseTranslationUnit(_In_z_ const char*									source_filename,
...
struct IDxcSourceLocation : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE GetSpellingLocation(_Outptr_opt_ IDxcFile** pFile, _Out_opt_ unsigned* pLine, _Out_opt_ unsigned* pCol, _Out_opt_ unsigned* pOffset) = 0;
	virtual HRESULT STDMETHODCALLTYPE IsNull(_Out_ BOOL* pResult)																										   = 0;
	virtual HRESULT STDMETHODCALLTYPE GetPresumedLocation(_Outptr_opt_ LPSTR* pFilename, _Out_opt_ unsigned* pLine, _Out_opt_ unsigned* pCol)							   = 0;
};
...
struct IDxcTranslationUnit : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE Tokenize(_In_ IDxcSourceRange* range, _Outptr_result_buffer_maybenull_(*pTokenCount) IDxcToken*** pTokens, _Out_ unsigned* pTokenCount) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetLocation(_In_ IDxcFile* file, unsigned line, unsigned column, _Outptr_result_nullonfailure_ IDxcSourceLocation** pResult)			  = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE Reparse(_In_count_(num_unsaved_files) IDxcUnsavedFile** unsaved_files, unsigned num_unsaved_files)									  = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE GetDiagnosticDetails(
		unsigned index, DxcDiagnosticDisplayOptions options, _Out_ unsigned* errorCode, _Out_ unsigned* errorLine, _Out_ unsigned* errorColumn, _Out_ BSTR* errorFile, _Out_ unsigned* errorOffset, _Out_ unsigned* errorLength, _Out_ BSTR* errorMessage) = 0;
	...
	CodeCompleteAt(_In_ const char* fileName, unsigned line, unsigned column, _In_ IDxcUnsavedFile** pUnsavedFiles, unsigned numUnsavedFiles, _In_ DxcCodeCompleteFlags options, _Outptr_result_nullonfailure_ IDxcCodeCompleteResults** pResult) = 0;
};
...
CLSID_SCOPE const CLSID CLSID_DxcIntelliSense = {/* 3047833c-d1c0-4b8e-9d40-102878605985 */
												 0x3047833c,
												 0xd1c0,
												 0x4b8e,
