...
public:
	...
	///@name Binary serialization of the shape. Note that this saves the 'cooked' shape in a format_t which will not be backwards compatible for newer library versions.
