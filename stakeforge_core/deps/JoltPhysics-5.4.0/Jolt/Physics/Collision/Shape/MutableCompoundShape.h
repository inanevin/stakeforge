...
private:
	...
	Array<Bounds>					mSubShapeBounds;											///< Bounding boxes of all sub shapes in SOA format_t (in blocks of 4 boxes), MinX 0..3, MinY 0..3, MinZ 0..3, MaxX 0..3, MaxY 0..3, MaxZ 0..3, MinX 4..7, MinY 4..7, ...
};
